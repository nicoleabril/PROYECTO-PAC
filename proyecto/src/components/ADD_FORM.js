...
const Add_Form = ({ onSubmit })=> {
  ...
  const obtenerIDProceso = async () => {
    try {
        const response = await Axios.get(`http://localhost:5000/obtener_id_proceso/`);
  ...
  return (
      ...
      <div className="pl-lg-4">
        <Row>
          <Col lg="6">
            <FormGroup>
              <label htmlFor="input-username">Área Requirente</label>
              <Input
                id="input-username"
                defaultValue={area}
          ...
          <Col lg="6">
            <FormGroup>
              <label htmlFor="input-email">Año</label>
              <Input
                id="input-email"
        ...
        <Row>
          <Col md="12">
            <FormGroup>
              <label htmlFor="justificacion-tecnica">Justificación Técnica</label>
              <Input 
                id="justificacion-tecnica"
                type="textarea"
        ...
        <Row>
          <Col md="12">
            <FormGroup>
              <label htmlFor="justificacion-economica">Justificación Económica</label>
              <Input
                id="justificacion-economica"
                type="textarea"
        ...
        <Row>
          <Col md="12">
            <FormGroup>
              <label htmlFor="justificacion-fortuita">Justificación Caso Fortuito / Fuerza mayor</label>
              <Input
      ...
      <hr className="hr" />
      <h6 className="titulosReforma">Solicitud Reforma</h6>
      <div className="pl-lg-4">
        <Row>
          <Col md="12">
            <FormGroup>
          ...
          <Col md="4">
            <FormGroup>
              <label>Fecha de Entrega de Documentos Habilitantes</label>
              <Input
          ...
          <Col md="4">
            <FormGroup>
              <label>Fecha Estimada de Publicación</label>
