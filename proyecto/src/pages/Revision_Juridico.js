...
function Revision_Juridico() {
  ...
  const editar_reforma = (id) => {
    ...
    localStorage.setItem('fase', 'Revisión Jurídico');
        ...
        <Row gutter={[24, 0]}>
          ...
          <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
            <div className="titleTable">
              <Title level={4} className="titleTable2" >Revisión Jurídico</Title>
...
export default Revision_Juridico;