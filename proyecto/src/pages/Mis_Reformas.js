...
class Mis_reformas extends Component {
    ...
    obtenerProcesosSinRevision = async () => {
        ...
        try {
            const response = await Axios.get(`http://190.154.254.187:5000/obtenerReformas/estado_revisor/Pendiente`);
            ...
            <div>
                ...
                <body style={body}>
                    ...
                    <div style={encabezaGrupoForm}>
                        <table width="100%">
                            <tr>
                                ...
                                <td style={{ width: '15%' }}><button onClick={this.mandarReformaARevision}>Revisar Reforma</button></td>
                            </tr>
                        </table>
                    </div>
                    <div id="tablaFiltrada" className="form-group" style={grupoForm}>
                        {this.state.procesosSinRevision.length > 0 ? (
                            <TablaFiltrada data={this.state.procesosSinRevision} columns={this.state.columns} editar={true} eliminar={true} visualizar={true} onSeleccionarFila={this.onFilaSeleccionada}/>
                        ) : (
                    ...
                    <div style={encabezaGrupoForm}>
                        <table width="100%">
                            <tr>
                                <td style={{ width: '80%' }}><label style={etiqueta}>Mis Reformas Para Revisión</label></td>
                                <td onClick={() => this.regresar_Inicio()} style={{ width: '10%' }}>Regresar</td>
                            </tr>
                        </table>
                    </div>
