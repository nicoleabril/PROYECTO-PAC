import {
  ...
  function Finalizar_Infima() {
    ...
    useEffect(() => {
        const obtenerProcesosSinRevision = async () => {
          const valor = 'EJECUCIÓN DE ORDEN DE COMPRA';
    ...
    const editar_reforma = (id) => {
      ...
      localStorage.setItem('fase', 'Ejecución de Orden de Compra');
          ...
          <Row gutter={[24, 0]}>
            ...
            <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
              <div className="titleTable">
                <Title level={4} className="titleTable2" >Finalizar Ínfima Cuantía</Title>
  ...
  export default Finalizar_Infima;