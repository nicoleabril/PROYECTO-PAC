...
import {
  ...
  const Edicion_Direccion = () => {
    ...
    const handleFormSubmit = async (formData) => {
      try {
        const response = await Axios.post(`http://localhost:5000/actualizarDireccion/`, 
        {
        id_direccion: idParaEditar,
        ...
        console.log('Respuesta del servidor:', response.data);
          ...
          console.error('Error al guardar información de direccion', error);
      }
    };
                ...
                <Card className="bg-secondary shadow">
                  <CardHeader className="headerReforma">
                    <Row className="align-items-center">
                      <Col xs="8">
                        <h3 className="mb-0">Editar Dirección</h3>
                      </Col>
                    </Row>
                  </CardHeader>
                  <CardBody>
  ...
  export default Edicion_Direccion;