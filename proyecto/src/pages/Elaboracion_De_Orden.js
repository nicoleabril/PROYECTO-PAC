import {
  ...
  function Elaboracion_De_Orden() {
    ...
    useEffect(() => {
        const obtenerProcesosSinRevision = async () => {
          const valor = 'ELABORACIÓN DE ORDEN DE COMPRA';
    ...
    const editar_reforma = (id) => {
      ...
      localStorage.setItem('fase', 'Elaboración de Orden de Compra');
          ...
          <Row gutter={[24, 0]}>
            ...
            <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
              <div className="titleTable">
                <Title level={4} className="titleTable2" >Elaboración de Orden de Compra</Title>
  ...
  export default Elaboracion_De_Orden;