import {
  ...
  function Solicitud_De_Publicacion() {
    ...
    useEffect(() => {
        const obtenerProcesosSinRevision = async () => {
          const valor = 'SOLICITUD DE PUBLICACIÓN DE NECESIDAD DE IFC';
    ...
    const editar_reforma = (id) => {
      ...
      localStorage.setItem('fase', 'Solicitud de Publicación de Necesidad de IFC');
          ...
          <Row gutter={[24, 0]}>
            ...
            <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
              <div className="titleTable">
                <Title level={4} className="titleTable2" >Solicitud de Públicación de Necesidad de IFC</Title>
  ...
  export default Solicitud_De_Publicacion;