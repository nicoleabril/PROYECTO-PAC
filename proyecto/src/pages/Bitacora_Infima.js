import {
  ...
  function Bitacora_Infima() {
    const history = useHistory();
    const id_infima = localStorage.getItem('id_infima');
    ...
    useEffect(() => {
      const obtenerComentarios = async () => {
        try {
            const response = await Axios.get(`http://localhost:5000/obtenerBitacora/${id_infima}`);
    ...
    const columnas = [
        ...
        },
        {
            title: 'Remitente',
            key: 'remitente',
            render: (text, record) => `${record.remitente}`,
            sorter: (a, b) => a.remitente.localeCompare(b.remitente) 
        },  
        {
          title: 'Destinatario',
          key: 'destinatario',
          render: (text, record) => `${record.destinatario}`,
      ...
      },
      {
          ...
          sorter: (a, b) => a.estado_inicial.length - b.estado_inicial.length,
      },
      {
        title: "Estado Final",
        key: "estado_final",
        dataIndex: "estado_final",
        sorter: (a, b) => a.estado_final.length - b.estado_final.length,
    },
    ];
        ...
        <Container className="contenedorTitleTable" fluid>
            ...
            <Row gutter={[24, 0]}>
                ...
                <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
                    ...
                    <Title level={4} className="titleTable2" >Revisar Bitácora</Title>
...
>
  ...
  export default Bitacora_Infima;