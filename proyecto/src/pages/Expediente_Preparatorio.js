...
function Expediente_Preparatorio() {
  ...
  useEffect(() => {
      const obtenerProcesosSinRevision = async () => {
        const valor = 'EXPEDIENTE PREPARATORIO';
  ...
  const editar_reforma = (id) => {
    ...
    localStorage.setItem('fase', 'Expediente Preparatorio');
        ...
        <Row gutter={[24, 0]}>
          ...
          <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
            <div className="titleTable">
              <Title level={4} className="titleTable2" >Firmar Expediente Preparatorio</Title>
...
export default Expediente_Preparatorio;