import {
  ...
  function Resolucion_De_Inicio_Cat() {
    ...
    useEffect(() => {
        const obtenerProcesosSinRevision = async () => {
          const valor = 'RESOLUCIÓN DE INICIO';
    ...
    const editar_reforma = (id) => {
      ...
      localStorage.setItem('fase', 'Resolución de Inicio');
          ...
          <Row gutter={[24, 0]}>
            ...
            <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
              <div className="titleTable">
                <Title level={4} className="titleTable2" >Resolución de Inicio</Title>
  ...
  export default Resolucion_De_Inicio_Cat;