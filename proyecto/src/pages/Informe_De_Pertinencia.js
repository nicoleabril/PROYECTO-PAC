...
function Informe_De_Pertinencia() {
  ...
  useEffect(() => {
      const obtenerProcesosSinRevision = async () => {
        const valor = 'SOLICITUD INFORME DE PERTINENCIA';
  ...
  const editar_reforma = (id) => {
    ...
    localStorage.setItem('fase', 'Informe de Pertinencia');
        ...
        <Row gutter={[24, 0]}>
          ...
          <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
            <div className="titleTable">
              <Title level={4} className="titleTable2" >Informe de Pertinencia</Title>
...
export default Informe_De_Pertinencia;