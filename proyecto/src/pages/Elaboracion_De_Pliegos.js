...
function Elaboracion_De_Pliegos() {
  ...
  useEffect(() => {
      const obtenerProcesosSinRevision = async () => {
        const valor = 'ELABORACIÓN DE PLIEGOS';
  ...
  const editar_reforma = (id) => {
    ...
    localStorage.setItem('fase', 'Pliegos');
        ...
        <Row gutter={[24, 0]}>
          ...
          <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
            <div className="titleTable">
              <Title level={4} className="titleTable2" >Elaboración de Pliegos</Title>
...
export default Elaboracion_De_Pliegos;