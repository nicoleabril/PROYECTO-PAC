import {
  ...
  function Liquidar_Catalogo_Electronico() {
    ...
    useEffect(() => {
        const obtenerProcesosSinRevision = async () => {
          const valor = 'LIQUIDAR CATALOGO ELECTRONICO';
    ...
    const editar_reforma = (id) => {
      ...
      localStorage.setItem('fase', 'Liquidar Catálogo Electrónico');
          ...
          <Row gutter={[24, 0]}>
            ...
            <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
              <div className="titleTable">
                <Title level={4} className="titleTable2" >Liquidar Catálogo Electrónico</Title>
  ...
  export default Liquidar_Catalogo_Electronico;