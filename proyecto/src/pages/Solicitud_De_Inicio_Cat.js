import {
  ...
  function Solicitud_De_Inicio_Cat() {
    ...
    useEffect(() => {
        const obtenerProcesosSinRevision = async () => {
          const valor = 'SOLICITUD DE INICIO';
    ...
    const editar_reforma = (id) => {
      ...
      localStorage.setItem('fase', 'Solicitud de Inicio');
          ...
          <Row gutter={[24, 0]}>
            ...
            <Card bordered={false} className="criclebox tablespace mb-24" style={{ height: 'fit-content' }}>
              <div className="titleTable">
                <Title level={4} className="titleTable2" >Solicitud de Inicio</Title>
  ...
  export default Solicitud_De_Inicio_Cat;